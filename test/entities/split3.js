...
Split3Model.prototype.showStats = function() {
    ...
    stat_animation_manager(this.view.image.node.id, "split3", 100);
...
var SplitterEntity = {
    ...
    Split3View = function(a, b, c, d, e) {
        ...
        for (b = 0; b < 3; b++) c = a.image("images/orange-arrow.gif", d, e, 8, 8), c.view = this, c.id = b, c.drag(function(a, b) {
            this.attr({
                x: this.ox + a,
                y: this.oy + b
            });
...
Split3View.prototype.acceptDrop = function(a, b) {
