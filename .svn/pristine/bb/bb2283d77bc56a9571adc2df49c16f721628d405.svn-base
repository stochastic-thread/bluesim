...
var ImageView = function(a, b, c, d, e, f, g) {
	...
	switch(b){
		case "source":
			this.image = a.image("images/source.png", d, e, 34, 34), this.height = this.width = 34;
			break;
		case "sink":
			this.height = this.width = 32, this.image = a.image("images/sink.png", d, e, this.width, this.height);
			break;
		case "queue":
			this.width = 116 * 0.8, this.height = 44, this.image = a.image("images/queue.png", d, e, this.width, this.height);
			break;
		// case "stack":
		// 	this.width = 116 * 0.8, this.height = 44, this.image = a.image("images/stack.png", d, e, this.width, this.height);
		// 	break;
		case "func":
			this.width = 38, this.height = 38, this.image = a.image("images/function.png", d, e, this.width, this.height);
			break;
//		case "splitfunc":
